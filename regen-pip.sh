wget https://raw.githubusercontent.com/pgadmin-org/pgadmin4/REL-8_10/requirements.txt
...
flatpak-pip-generator --yaml -r requirements_filtered.txt --ignore-pkg bcrypt==4.1.* cryptography==42.0.*
